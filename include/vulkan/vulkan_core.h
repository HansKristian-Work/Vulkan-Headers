...
typedef enum VkStructureType {
    ...
    VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_MUTABLE_DESCRIPTOR_TYPE_CREATE_INFO_VALVE = 1000351002,
...
#define VK_VALVE_MUTABLE_DESCRIPTOR_TYPE_SPEC_VERSION 2
...
typedef struct VkMutableTypeDescriptorListVALVE {
    uint32_t             descriptorTypeCount;
    VkDescriptorType*    pDescriptorTypes;
} VkMutableTypeDescriptorListVALVE;

typedef struct VkDescriptorSetLayoutMutableDescriptorTypeCreateInfoVALVE {
    VkStructureType                            sType;
    const void*                                pNext;
    uint32_t                                   bindingCount;
    const VkMutableTypeDescriptorListVALVE*    pMutableDescriptorTypeLists;
} VkDescriptorSetLayoutMutableDescriptorTypeCreateInfoVALVE;
